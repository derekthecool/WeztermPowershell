...
Describe 'Module Tests' -Tag Unit {
    Context "Module Tests" {
        ...
        It 'root module WeztermPowershell.psm1 should exist' {
            $PathToModule | Should -Exist
            $? | Should -BeTrue
        } #psm1Exists
        It 'manifest should contain WeztermPowershell.psm1' {
            $PathToManifest |
            Should -FileContentMatchExactly "WeztermPowershell.psm1"
        } #validPSM1
